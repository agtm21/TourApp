@extends('Nelayan.homepage',['title'=>'Profile'])
@section('profile')
        ...
        <div class="col col-md-4">
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center shadow">
                    ...
                    @else
                        <img class="img-account-profile rounded-circle mb-2" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="" width="250px" height="250px" >
                    @endif
